...
func NewRouter(cfg config.Config, authSvc *service.AuthService, wargameSvc *service.WargameService, userSvc *service.UserService, affiliationSvc *service.AffiliationService, scoreSvc *service.ScoreboardService, stackSvc *service.StackService, vmSvc *service.VMService, redis *redis.Client, logger *logging.Logger) *gin.Engine {
	...
	api := r.Group("/api")
	{
		...
		api.GET("/challenge-series", h.ListChallengeSeries)
		api.GET("/challenge-series/:id", h.GetChallengeSeries)
		...
		unblocked.POST("/community", h.CreateCommunityPost)
		...
		admin.POST("/challenge-series", h.CreateChallengeSeries)
		admin.PUT("/challenge-series/:id", h.UpdateChallengeSeries)
		admin.DELETE("/challenge-series/:id", h.DeleteChallengeSeries)
		admin.PUT("/challenge-series/:id/challenges", h.ReplaceChallengeSeriesChallenges)
