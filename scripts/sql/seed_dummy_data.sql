...
TRUNCATE TABLE challenge_series_challenges, challenge_series, challenge_comments, challenge_votes, writeups, submissions, stacks, challenges, users, affiliations RESTART IDENTITY CASCADE;
